...
export const utilities = defineUtilities({
  ...
  focusRingOffset: {
    values: 'spacing',
    transform: (v: any) => ({ '--focus-ring-offset': v }),
  },
  focusRingWidth: {
    values: 'borderWidths',
    property: 'outlineWidth',
    transform: (v: any) => ({ '--focus-ring-width': v }),
  },
  focusRingStyle: {
    values: 'borderStyles',
    property: 'outlineStyle',
    transform: (v: any) => ({ '--focus-ring-style': v }),
  },
  boxSize: {
    values: 'sizes',
    transform: (value: any) => ({ width: value, height: value }),
  },
});
